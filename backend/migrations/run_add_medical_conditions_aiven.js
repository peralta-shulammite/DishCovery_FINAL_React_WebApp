// Migration script to add standard medical conditions to Aiven database
...
async function runMigration() {
  let connection;
  try {
    console.log('🔄 Starting migration: Add standard medical conditions to Aiven...');
    ...
    // Step 3: Clean up recipe_restrictions for category 3 FIRST (before deleting restrictions)
    console.log('📝 Step 3: Cleaning up recipe_restrictions for category 3...');
    ...
    // Step 4: Clean up user_restrictions for category 3 FIRST (before deleting restrictions)
    console.log('📝 Step 4: Cleaning up user_restrictions for category 3...');
    ...
    // Step 5: Delete category_id 3 restrictions (now safe to delete)
    console.log('📝 Step 5: Deleting category_id 3 restrictions...');
    ...
    // Step 6: Clean up ALL recipe_restrictions FIRST (before deleting all restrictions)
    console.log('📝 Step 6: Cleaning up all recipe_restrictions...');
    const [allRecipeRestrictionsResult] = await connection.query(`DELETE FROM recipe_restrictions`);
    console.log(`✅ Cleaned up ${allRecipeRestrictionsResult.affectedRows} recipe_restrictions`);
    
    // Step 7: Clean up ALL user_restrictions FIRST (before deleting all restrictions)
    console.log('📝 Step 7: Cleaning up all user_restrictions...');
    const [allUserRestrictionsResult] = await connection.query(`DELETE FROM user_restrictions`);
    console.log(`✅ Cleaned up ${allUserRestrictionsResult.affectedRows} user_restrictions`);
    
    // Step 8: Delete ALL existing restrictions (now safe to delete)
    console.log('📝 Step 8: Deleting all existing restrictions...');
